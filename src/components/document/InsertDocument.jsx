...
function InsertDocument() {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setFileData({ ...fileData, FileData: reader.result.substring(5, reader.result.length), FileClientName: file.name });
      };
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, DocDescription: e.target.value })
                  }
                  rows={4}
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-100"
                ></textarea>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  onChange={(e) => setFileData({ ...fileData, FileClientDescription: e.target.value })}
                  rows={4}
                  className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-100"
                ></textarea>
              </div>
